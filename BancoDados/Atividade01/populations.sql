...
insert into orders(id_orders, tId, cId, dates, status) values (1, 1, 2, '2025-03-29', 'aberto');
insert into orders(id_orders, tId, cId, dates, status) values (2, 3, 1, '2025-03-01', 'aberto');